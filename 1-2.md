...
Crea [arreglos](https://es.wikipedia.org/wiki/Vector_(informática)) (*array*) y [diccionarios](https://es.wikipedia.org/wiki/Vector_asociativo) usando corchetes (```[]```) y accede sus elementos escribiendo el índice o llave en corchetes. Una coma se permite después del primer elemento.
