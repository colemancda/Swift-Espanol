...
[^2] Nivel o contexto, se conoce como *scope* en inglés. [Wikipedia](https://es.wikipedia.org/wiki/Contexto_(informática))

[^3] Conocido como *String* en inglés y la mayoria de lenguajes de programación.
