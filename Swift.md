...
Swift es amigable para nuevos programmadores. Es el primer lenguaje de programmacion de sistemas de calidad industrial que es tan expresivo y agradable como un lenguaje [interpretado](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#Intérprete). Soporta [parque de juegos](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#) (*playgrounds*), una caractrerisitca innovadora que permite programmadores experimentar con codigo Swift y ver los resultados immediatamente, sin el gasto de compilar y correr la applicacion.
