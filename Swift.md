...
[Swift](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#swift) es una nueva lenguaje de programmacion para applicaciones de iOS, OS X, watchOS, y tvOS que estan cimentados en lo mejor de [C](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#c) y [Objective-C](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#objective-c), sin las restricciones de compatibilidad con C. Swift adopta patrones de programmacion seguros y añade caracterisitacas modernas para hacer programacion mas facil, mas flexible, y mas divertido. La implementacion nueva y limpia de Swift, apoyado por los [marcos de trabajo](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#marco-de-trabajo) de [Cocoa](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#cocoa) y [Cocoa Touch](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#cocoa-touch), es una oportunidad para reimaginar como funciona el desarollo de [software](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#software).

El proceso de la creacion de Swift ha estado ocurriendo por varios años. [Apple](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#apple) creo el cimiento para Swift cuando avanzamos nuestra infraestructura de compilador, debuggeador y marcos de trabajo. Hemos simplificado manejo de memoria con [Conteo de Referencia Automatica](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#conteo-de-referencia-automatica). Nuestras marcos de trabajo, construidas sobre la base solida de [Foundation](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#foundation) y Cocoa, ha sido modernizada y estandarizado. Objective-C mismo ha evolucionado para soportar [clausuras](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#clausura), colleciones literales, y modulos, habilitando que marcos de trabajo adopten technologias de lenguajes modernas sin obstaculos. Gracias a este trabajo, podemos introducir una nueva lengauaje de desarollo para el futuro de desarollo de Software para las plataformas de Apple.

Swift se siente familiar para desarolladores de Objective-C. Adopta la legibilidad de parametros nombrados y el poder del modelo de objectos dynamicos de Objective-C. Proveee acceso sin interrupciones a marcos de trabajo existentes de Cocoa y completa interoperabilidad con codigo Objective-C. Construyendo encima de esta fundacion, Swift introduce muchos nuevos conceptos y unifica las porciones [procedurales](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#procedural) y [orientados a objectos](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#orientado-a-objetos) del lenguaje.

Swift es amigable para nuevos programmadores. Es el primer lenguaje de programmacion de sistemas de calidad industrial que es tan expresivo y agradable como un lenguaje [interpretado](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#intérprete). Soporta [parque de juegos](https://github.com/colemancda/Swift-Espanol/blob/master/Glosario.md#parque-de-juegos), una caracteristica innovadora que permite programmadores experimentar con codigo Swift y ver los resultados immediatamente, sin el gasto de compilar y correr la applicacion.
